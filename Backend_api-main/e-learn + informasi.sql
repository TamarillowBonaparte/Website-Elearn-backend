...
(3, 9, 'b3b3k4040', 'BebekDosen', 'bebekd@gmail.com', 'Bebek Land', '2000-01-06', 'L', 'Islam', 'jalan bebek', '06969696969', '2025-11-27 15:31:22', '2025-11-28 13:42:21');
...
CREATE TABLE `informasi` (
  ...
  `gambar_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `target_role` enum('all','mahasiswa','dosen') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'all',
...
(5, 'Testing DOsen', 'aku dosen wou', NULL, 1, 80, '2025-12-02 18:41:00', '2025-12-03 18:41:00', 'dosen', 2, '2025-12-02 18:41:58', '2025-12-02 18:41:58');
...
(10, 'BebekMaha', 'BebekMa@gmail.com', '$2b$12$aDhXfj0hFXoSepBy/bwQwO.ogb0ppCp1cYbAz6K/BIf0.IsWWW3/i', 'mahasiswa', 1, '2025-11-28 10:28:35', '2025-11-28 10:28:35');
...
ALTER TABLE `informasi`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_informasi_is_active` (`is_active`),
  ADD KEY `idx_informasi_priority` (`priority`),
  ADD KEY `idx_informasi_created_at` (`created_at`),
  ADD KEY `idx_informasi_target_role` (`target_role`),
  ADD KEY `idx_informasi_created_by` (`created_by`),
  ADD KEY `idx_informasi_tanggal_mulai` (`tanggal_mulai`),
  ADD KEY `idx_informasi_tanggal_selesai` (`tanggal_selesai`),
  ADD KEY `idx_informasi_active_priority_created` (`is_active`,`priority`,`created_at`),
  ADD KEY `idx_informasi_date_range` (`is_active`,`tanggal_mulai`,`tanggal_selesai`);
...
--
ALTER TABLE `informasi`
  ADD CONSTRAINT `fk_informasi_created_by` FOREIGN KEY (`created_by`) REFERENCES `users` (`id_user`) ON DELETE CASCADE;
