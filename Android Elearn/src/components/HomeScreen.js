...
const HomeScreen = ({
      ...
      try {
        ...
        if (response.data && Array.isArray(response.data)) {
          ...
          const filteredPresensi = response.data.filter((p) => {
            ...
            // Hanya tampilkan jika: waktu belum habis ATAU sudah hadir
    ...
    const fetchMateriData = async (id_kelas) => {
      try {
        console.log(`🔄 Fetching materi data for id_kelas: ${id_kelas}`);
        const token = await AsyncStorage.getItem('access_token');
    ...
    const handleMateriPress = (materi) => {
      if (materi.file_pdf) {
        // Navigasi ke MateriEyeTracking dengan eye tracking
        ...
        >
          <View style={styles.headerTop}>
            ...
            <TouchableOpacity
              ...
              onPress={() => Alert.alert('Notifikasi', 'Fitur notifikasi belum diimplementasikan')}
            >
        ...
        >
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              ...
              <Text style={[styles.seeAll, { color: '#94A3B8' }]}>
                {presensiHariIni.length} Presensi
              </Text>
            </View>
            ...
            {presensiHariIni.length > 0 ? (
              presensiHariIni.map((presensi, index) => (
                <TouchableOpacity
                  ...
                  onPress={() => handlePresensiClick(presensi)}
                >
                  <View style={styles.presenceLeft}>
                    ...
                    <View style={styles.presenceContent}>
                      ...
                      <Text style={styles.presenceSubtitle}>
                        Pertemuan {presensi.pertemuan_ke} • {presensi.kelas || ''}
                      </Text>
                      ...
                      <View style={styles.presenceDetails}>
                        <View style={styles.presenceDetailItem}>
                          ...
                          <Text style={styles.presenceDetailText}>
                            {presensi.waktu_mulai || '-'} - {presensi.waktu_selesai || '-'}
                          </Text>
                        </View>
                        ...
                        <View style={styles.presenceDetailItem}>
                          <Text
                            style={[
                              styles.presenceDetailText,
                              { color: getStatusColor(presensi.status), fontWeight: '700', fontSize: 13 },
                            ]}
                          >
                            {presensi.status}
                          </Text>
          ...
          {presensiList.length > presensiHariIni.length && (
            <View style={styles.section}>
              <View style={styles.sectionHeader}>
                ...
                <Text style={[styles.seeAll, { color: '#94A3B8' }]}>
                  {presensiList.length - presensiHariIni.length} Lainnya
                </Text>
              </View>
                  ...
                  >
                    <View style={styles.presenceLeft}>
                      ...
                      <View style={styles.presenceContent}>
                        <Text style={styles.presenceTitle}>{presensi.nama_mk}</Text>
                        <Text style={styles.presenceSubtitle}>
                          Pertemuan {presensi.pertemuan_ke} • {formatDate(presensi.tanggal)}
                        </Text>
          ...
          <View style={styles.section}>
            ...
            {materiPreview.length > 0 ? (
                ...
                >
                  <View style={styles.materiHeader}>
                    <View style={styles.materiLeft}>
                      ...
                      <View style={styles.materiInfo}>
                        ...
                        <Text style={styles.materiSubtitle}>
                          Minggu {materi.minggu} • {materi.kode_mk}
                        </Text>
                        {materi.deskripsi && (
                    ...
                    <View style={styles.materiRight}>
                      <Text style={styles.materiDate}>{formatTanggalUpload(materi.tanggal_upload)}</Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.materiFooter}>
                    ...
                    <TouchableOpacity style={styles.openMateriButton} onPress={() => handleMateriPress(materi)}>
              ...
              <View style={[styles.materiCard, { backgroundColor: '#F8FAFC' }]}>
                <View style={styles.materiHeader}>
                  <View style={styles.materiLeft}>
                    <View style={styles.materiIcon}>
                      <Text style={styles.presenceIconText}>📚</Text>
